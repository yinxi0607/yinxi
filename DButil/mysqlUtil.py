    ...
    def __getConn():
        ...
        if Mysql.__pool is None:
            __pool = PooledDB(creator=MySQLdb, mincached=1, maxcached=20,
                              host=configuration.config_DB.DBHOST, port=configuration.config_DB.DBPORT, user=configuration.config_DB.DBUSER, passwd=configuration.config_DB.DBPWD,
                              db=configuration.config_DB.DBNAME, use_unicode=False, charset=configuration.config_DB.DBCHAR, cursorclass=DictCursor)
